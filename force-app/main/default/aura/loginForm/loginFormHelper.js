({
    ...
    getIsSelfRegistrationEnabled : function (component, event, helpler) {
        ...
        action.setCallback(this, function(a){
            ...
            if (rtnValue !== null) {
                ...
                console.log('@@selfregister'+rtnValue);
            }
        });
        $A.enqueueAction(action);
    },
    ...
    getNetworkName: function (component, event, helpler) {
        var action = component.get("c.getNetworkName");
        action.setCallback(this, function(a){
            var rtnValue = a.getReturnValue();
            if (rtnValue !== null) {
                component.set('v.networkName',rtnValue);
            }
        });
        $A.enqueueAction(action);
    }
