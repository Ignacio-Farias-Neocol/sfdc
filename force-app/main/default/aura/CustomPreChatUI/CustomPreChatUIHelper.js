({
    ...
    */
    ...
    getSupportPrechatFieldAttributesArray: function(prechatFields) {
        var supportPrechatFieldsInfoArray = [];
        prechatFields.forEach(function(field) {
            ...
            if (field.name === "Web_Serial__c" || field.name === "Web_Existing_Case__c") {
                supportPrechatFieldsInfoArray.push(componentInfoArray);
            }
		});
        return supportPrechatFieldsInfoArray;
    },
    ...
    */
	getPrechatFieldAttributesArray: function(changeEvent, prechatFields) {
